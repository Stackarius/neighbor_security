...
export default function ReportsPage() {
  ...
  return (
    <div className="relative p-6 md:px-12">
      {showForm && (
        <div className="absolute top-0 left-0 flex items-center justify-center h-[100vh] w-full bg-black/80 p-5 rounded-lg shadow-lg">
          <div className="relative">
            <FaTimes className="absolute top-2 right-2 text-black cursor-pointer" onClick={() => setShowForm(false)} />
            {showForm && <ReportForm onClose={() => {
              setShowForm(false) 
              fetchReports()
            }} />}
          </div>
